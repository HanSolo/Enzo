    ...
    public final Gauge build() {
        ...
        properties.forEach((key, property) -> {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.setNeedleColor(((ObjectProperty<Color>) property).get());
            } else if("tickLabelOrientation".equals(key)) {
                CONTROL.setTickLabelOrientation(((ObjectProperty<Gauge.TickLabelOrientation>) property).get());
            } else if("numberFormat".equals(key)) {
                CONTROL.setNumberFormat(((ObjectProperty<Gauge.NumberFormat>) property).get());
            } else if("majorTickSpace".equals(key)) {
                CONTROL.setMajorTickSpace(((DoubleProperty) property).get());
                ...
                CONTROL.setHistogramEnabled(((BooleanProperty) property).get());
            } else if("dropShadowEnabled".equals(key)) {
                CONTROL.setDropShadowEnabled(((BooleanProperty) property).get());
            } else if("tickLabelFill".equals(key)) {
                CONTROL.setTickLabelFill(((ObjectProperty<Color>) property).get());
                ...
                CONTROL.setHistogramFill(((ObjectProperty<Color>) property).get());
