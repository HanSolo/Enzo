 ...
 * Time: 16:37
 */
public class SimpleLinearGaugeBuilder<B extends SimpleLinearGaugeBuilder<B>> {
    private HashMap<String, Property> properties = new HashMap<>();


    // ******************** Constructors **************************************
    protected SimpleLinearGaugeBuilder() {}


    // ******************** Methods *******************************************
    public static final SimpleLinearGaugeBuilder create() {
        return new SimpleLinearGaugeBuilder();
    }

    public final SimpleLinearGaugeBuilder value(final double VALUE) {
        properties.put("value", new SimpleDoubleProperty(VALUE));
        return this;
    }

    public final SimpleLinearGaugeBuilder minValue(final double MIN_VALUE) {
        properties.put("minValue", new SimpleDoubleProperty(MIN_VALUE));
        return this;
    }

    public final SimpleLinearGaugeBuilder maxValue(final double MAX_VALUE) {
        properties.put("maxValue", new SimpleDoubleProperty(MAX_VALUE));
        return this;
    }

    public final SimpleLinearGaugeBuilder threshold(final double THRESHOLD) {
        properties.put("threshold", new SimpleDoubleProperty(THRESHOLD));
        return this;
    }

    public final SimpleLinearGaugeBuilder sections(final Section... SECTIONS) {
        properties.put("sectionsArray", new SimpleObjectProperty<>(SECTIONS));
        return this;
    }

    public final SimpleLinearGaugeBuilder sections(final List<Section> SECTIONS) {
        properties.put("sectionsList", new SimpleObjectProperty<>(SECTIONS));
        return this;
    }

    public final SimpleLinearGaugeBuilder decimals(final int DECIMALS) {
        properties.put("decimals", new SimpleIntegerProperty(DECIMALS));
        return this;
    }

    public final SimpleLinearGaugeBuilder segmented(final boolean SEGMENTED) {
        properties.put("segmented", new SimpleBooleanProperty(SEGMENTED));
        return this;
    }

    public final SimpleLinearGaugeBuilder round(final boolean ROUND) {
        properties.put("round", new SimpleBooleanProperty(ROUND));
        return this;
    }

    public final SimpleLinearGaugeBuilder title(final String TITLE) {
        properties.put("title", new SimpleStringProperty(TITLE));
        return this;
    }

    public final SimpleLinearGaugeBuilder unit(final String UNIT) {
        properties.put("unit", new SimpleStringProperty(UNIT));
        return this;
    }

    public final SimpleLinearGaugeBuilder animated(final boolean ANIMATED) {
        properties.put("animated", new SimpleBooleanProperty(ANIMATED));
        return this;
    }

    public final SimpleLinearGaugeBuilder animationDuration(final double ANIMATION_DURATION) {
        properties.put("animationDuration", new SimpleDoubleProperty(ANIMATION_DURATION));
        return this;
    }

    public final SimpleLinearGaugeBuilder barWidth(final double BAR_WIDTH) {
        properties.put("barWidth", new SimpleDoubleProperty(BAR_WIDTH));
        return this;
    }

    public final SimpleLinearGaugeBuilder barBackgroundFill(final Color BAR_BACKGROUND_FILL) {
        properties.put("barBackgroundFill", new SimpleObjectProperty<>(BAR_BACKGROUND_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder barFill(final Color BAR_FILL) {
        properties.put("barFill", new SimpleObjectProperty<>(BAR_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder valueColor(final Color VALUE_COLOR) {
        properties.put("valueColor", new SimpleObjectProperty<>(VALUE_COLOR));
        return this;
    }

    public final SimpleLinearGaugeBuilder labelColor(final Color LABEL_COLOR) {
        properties.put("labelColor", new SimpleObjectProperty<>(LABEL_COLOR));
        return this;
    }

    public final SimpleLinearGaugeBuilder section0Fill(final Color SECTION_0_FILL) {
        properties.put("section0Fill", new SimpleObjectProperty<>(SECTION_0_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section1Fill(final Color SECTION_1_FILL) {
        properties.put("section1Fill", new SimpleObjectProperty<>(SECTION_1_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section2Fill(final Color SECTION_2_FILL) {
        properties.put("section2Fill", new SimpleObjectProperty<>(SECTION_2_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section3Fill(final Color SECTION_3_FILL) {
        properties.put("section3Fill", new SimpleObjectProperty<>(SECTION_3_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section4Fill(final Color SECTION_4_FILL) {
        properties.put("section4Fill", new SimpleObjectProperty<>(SECTION_4_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section5Fill(final Color SECTION_5_FILL) {
        properties.put("section5Fill", new SimpleObjectProperty<>(SECTION_5_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section6Fill(final Color SECTION_6_FILL) {
        properties.put("section6Fill", new SimpleObjectProperty<>(SECTION_6_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section7Fill(final Color SECTION_7_FILL) {
        properties.put("section7Fill", new SimpleObjectProperty<>(SECTION_7_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section8Fill(final Color SECTION_8_FILL) {
        properties.put("section8Fill", new SimpleObjectProperty<>(SECTION_8_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder section9Fill(final Color SECTION_9_FILL) {
        properties.put("section9Fill", new SimpleObjectProperty<>(SECTION_9_FILL));
        return this;
    }

    public final SimpleLinearGaugeBuilder styleClass(final String STYLE) {
    ...
    public final SimpleLinearGauge build() {
        final SimpleLinearGauge CONTROL = new SimpleLinearGauge();
