    ...
    public final SimpleIndicator build() {
        ...
        properties.forEach((key, property) -> {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.getStyleClass().setAll("indicator", ((StringProperty) property).get());
            } else if ("indicatorStyle".equals(key)) {
                CONTROL.setIndicatorStyle(((ObjectProperty<SimpleIndicator.IndicatorStyle>) property).get());
            }
        });
        return CONTROL;
    }
