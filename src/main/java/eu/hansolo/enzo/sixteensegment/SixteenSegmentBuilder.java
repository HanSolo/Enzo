    ...
    public final SixteenSegment build() {
        ...
        properties.forEach((key, property) -> {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.getStyleClass().setAll("sixteen-segment", ((StringProperty) property).get());
            } else if ("segmentStyle".equals(key)) {
                CONTROL.setSegmentStyle(((ObjectProperty<SixteenSegment.SegmentStyle>) property).get());
