    ...
    public final QlockTwo build() {
        ...
        properties.forEach((key, property) -> {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.setColor(((ObjectProperty<QlockTwo.QlockColor>) property).get());
            } else if ("language".equals(key)) {
                CONTROL.setLanguage(((ObjectProperty<QlockTwo.Language>) property).get());
            } else if ("secondsMode".equals(key)) {
                CONTROL.setSecondsMode(((BooleanProperty) property).get());
